...
if os.path.isfile('/Users/yi-linghwong/keys/twitter_api_keys_5.txt'):
    lines = open('/Users/yi-linghwong/keys/twitter_api_keys_5.txt','r').readlines()
...
class listener(StreamListener):
    ...
    def on_data(self, status):
        ...
        for n in range(5):
            ...
            try:
                ...
                collection = db['astrobiology_collection']
                ...
                #         to='+61406815706',
                #         from_='+61447752987',
                #         body='astrobiology failed ondata',
                #     )
                #
                #     self.flag = False
    ...
    def on_error(self, status):
        ...
        #     to='+61406815706',
        #     from_='+61447752987',
        #     body='astrobiology failed on error',
        # )
