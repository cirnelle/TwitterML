    ...
    def on_data(self, status):
        ...
        for n in range(5):
            ...
            try:
                ...
                collection = db['planets_collection']
...
if __name__ == '__main__':
    ...
    stream.filter(languages=["en"],track=['solar system,pluto,#mars,mars planet,mars space,red planet,jupiter,enceladus,europa moon,europa jupiter,saturn,uranus,titan moon,titan saturn,ganymede moon,ganymede jupiter,#planets,asteroid,comet'], async=True)
