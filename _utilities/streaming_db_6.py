...
if os.path.isfile('/Users/yi-linghwong/keys/twitter_api_keys_20.txt'):
    lines = open('/Users/yi-linghwong/keys/twitter_api_keys_20.txt','r').readlines()
    ...
    def on_data(self, status):
        ...
        for n in range(5):
            ...
            try:
                ...
                collection = db['climate_collection']
