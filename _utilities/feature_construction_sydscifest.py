...
path_to_labelled_raw_file = '../output/to_predict/sydscifest/labelled_raw_festival_tweets.csv'
...
path_to_store_combined_feature_file = '../output/to_predict/sydscifest/combined.txt'
...
path_to_store_labelled_combined_features_file = '../output/to_predict/sydscifest/labelled_combined.txt'
...
analytic_top = 98.0
analytic_bottom = 92.0
clout_top = 73.0
clout_bottom = 50.0
authentic_top = 43.0
authentic_bottom = 1.06
tone_top = 88.0
tone_bottom = 25.0
sixltr_top = 27.0
sixltr_bottom = 15.0
